...
HD_PWD='C:/Users/Marius/Proiecte_AC/TestEnv/TestEnv.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TestEnv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TestEnv.tcl

...
HD_PWD='C:/Users/Marius/Proiecte_AC/TestEnv/TestEnv.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TestEnv.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TestEnv.tcl -notrace
